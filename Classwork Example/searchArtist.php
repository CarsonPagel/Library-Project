...
if (isset($_SESSION["userid"]) && $_SESSION["userid"]!="")
{
    ...
    if(isset($_GET["firstname"]))
    {
        ...
        {   //Read the form data
            ...
            //echo $sql;
            $searchString = "?firstname=".$firstname."&lastname=".$lastname."&nationality=".$nationality;
            // echo $searchString;
            ...
            {   echo "<table border=\"1\">";
                ...
                {
                    echo "<tr>";
                    echo "<td><a href=\"findPaintings.php?id=".$row["artistid"]."&fname=".$row["firstname"]."&lname=".$row["lastname"]. "\">".$row["artistid"] ."</a></td>";
